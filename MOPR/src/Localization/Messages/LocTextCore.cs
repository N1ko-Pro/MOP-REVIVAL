...
namespace MOPR.Localization
{
    internal static class LocTextCore
    {
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "settings.parking_brake_anchor", "Parking brake anchor" },
            { "settings.parking_brake_anchor_hint", "<color=#9AA6B2>Stops the Satsuma from slowly sliding down slopes with the handbrake up. Anchors only after it stops, and never blocks jacking.</color>" },
        ...
        private static readonly Dictionary<string, string> Russian = new Dictionary<string, string>
        {
            ...
            { "settings.parking_brake_anchor", "Якорь ручника" },
            { "settings.parking_brake_anchor_hint", "<color=#9AA6B2>Не даёт Сатсуме сползать по уклону с поднятым ручником. Якорит только после остановки и никогда не мешает поднять машину домкратом.</color>" },
