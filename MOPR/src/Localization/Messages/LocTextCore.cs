...
namespace MOPR.Localization
{
    internal static class LocTextCore
    {
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "settings.parking_brake_anchor", "Parking brake anchor (Satsuma)" },
            { "settings.parking_brake_anchor_hint", "<color=#9AA6B2>Stops the Satsuma from creeping or drifting on slopes while its handbrake is fully engaged. Only its horizontal movement is held, so you can still jack it up and it won't slide off the jack; releasing the handbrake frees it instantly.</color>" },
        ...
        private static readonly Dictionary<string, string> Russian = new Dictionary<string, string>
        {
            ...
            { "settings.parking_brake_anchor", "Якорь ручника (Сатсума)" },
            { "settings.parking_brake_anchor_hint", "<color=#9AA6B2>Не даёт Сатсуме скатываться и «плыть» на склонах, пока ручник полностью поднят. Держит только горизонтальное перемещение, поэтому машину по-прежнему можно поднять домкратом и она с него не соскальзывает; при опускании ручника сразу освобождает.</color>" },
